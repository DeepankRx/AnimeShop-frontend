...
const ProductPageSkelton = () => {
  ...
  return (
    <div className="px-20 py-4 lgrev:p-4 flex lgrev:flex-col gap-4">
      <div className="col-span-1 p-4 border border-gray-200 rounded shadow animate-pulse md:p-6 dark:border-gray-700 w-[100%]">
