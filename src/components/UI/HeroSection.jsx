  ...
  return (
    <div className={`md:h-[720px] flex  mdrev:flex-col text-white relative `}>
      <div className={` md:w-[50%] bg-gradient-to-tl from-[#DD2476] to-[#FF512F]  flex flex-col justify-center px-10 smrev:px-2 mdrev:h-[400px] gap-4 `}>
        <div className="text-7xl font-semibold mdrev:text-5xl" id="Monton">
          {currentHero.text.para1}
        </div>
        <div className="text-7xl font-semibold mdrev:text-5xl" id="RubyVinyl">
          {currentHero.text.para2}
        </div>
        <div className="font-semibold text-xl mdrev:text-lg" id="Poppins">
          {currentHero.text.para3}
        </div>
        <Link to="/category">
      ...
      <div className="md:w-[60%] bg-slate-400 overflow-hidden">
        <img src={currentHero.image} className="h-[100%] object-cover w-[100%]" alt="hero" />
      </div>
      <div className="absolute right-8 bottom-3 flex gap-1 translate-y-8">
        <Button onClick={prevHeroHandler} classname="p-2 shadow-md rounded-full bg-[#fff]">
          <ArrowBackIcon sx={{ color: 'black' }} />
        </Button>
        <Button onClick={nextHeroHandler} classname="p-2 shadow-md rounded-full bg-[#fff]">
