  ...
  return (
    <div className='shadow-lg  p-4 flex space-x-8 rounded-lg'>
        ...
        <div className='space-y-1 '>
            ...
            <div className='text-xs'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Magni corrupti voluptatum necessitatibus vitae tempore quas. Et exercitationem ad quam nobis ea molestias animi rem dignissimos </div>
        ...
        <div className='flex space-x-2'>
            <div className='border-2 rounded-md px-2 border-purple-500'><HeartIcon fontSize='large'/></div>
