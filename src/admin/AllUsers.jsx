    ...
    return (
      ...
      >
        <div className="flex flex-col gap-4">
          <img src={user.profilePicture} alt="user" className="w-20 h-20 rounded-full" />
        ...
        <select className="border-[1px] border-black rounded-md p-1" value={role ? role : user.role} onChange={(e) => setRole(e.target.value)}>
