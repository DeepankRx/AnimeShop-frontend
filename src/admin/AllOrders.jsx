...
const AllOrders = () => {
    ...
    const handleChangeOrderStatus=(id,orderStatus)=>{
        ...
        changeOrderStatus(id,orderStatus).then((res)=>{
      ...
      const [orderStatus,setOrderStatus]=useState('')
        ...
        return(
          ...
          <div className='flex justify-center gap-6'>
                        ...
                        <Button variant='contained' onClick={()=>handleChangeOrderStatus(details._id,orderStatus)}>Change Status</Button>
    ...
    return (
        ...
        <h2 className='text-5xl mdrev:text-4xl md:p-4 md:gap-10' id='Monton'>Your Orders</h2>
