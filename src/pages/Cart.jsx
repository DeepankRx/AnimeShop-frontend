...
const Cart = () => {
    const Product=()=>{
        ...
        <div className='flex  gap-2 items-center'>
            <div className='w-[100px]'><img src={assets.bg_01}/> </div>
            <h2 className='text-xl font-bold'>Product ka Name</h2>
        </div>
        <h2 className='text-xl font-bold'>₹ 999</h2>
            <div className='flex items-center gap-3'>
                <FontAwesomeIcon icon={faCaretLeft} size='sm' className='cursor-pointer w-8 h-8 bg-gray-200 rounded-full'/>
            ...
            <FontAwesomeIcon icon={faTrash} color='red' size='2x' className='cursor-pointer mdrev:self-end hover:opacity-50 '/>
  ...
  return (
    ...
    <div id='Poppins' className='p-8  flex flex-col gap-8 w-[80%] m-auto mdrev:w-[100%]'>
        <h2 className='text-5xl ' id='Monton'><span className='border-b-4 border-black '>MY CART (4)</span></h2>
