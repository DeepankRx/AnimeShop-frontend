  ...
  return (
    <div className="lg:flex h-[calc(100vh_-_73px)]">
      <div className="w-[50%] lgrev:hidden bg-gradient-to-tr from-[#FCEE21] to-[#009245]">
        <img src={assets.online_shop} className="w-[100%] h-[100%] object-contain" alt="online_shop" />
      </div>
      <div className="lg:w-[50%] h-[100%] flex flex-col items-center justify-center">
        <Formik initialValues={initialValues} validationSchema={validateSchema} onSubmit={onSubmit}>
          <Form className=" bg-white w-[80%] p-8 shadow-lg  rounded-lg flex flex-col gap-2 smrev:w-[90%]">
            <div className="text-center text-2xl font-bold">Signup</div>
            <div className="w-[100%] gap-4 grid grid-cols-2">
              <InputField className="col-span-1 smrev:col-span-2" labelName="First Name" type="text" uni="firstName" placeholder="First Name" />
              <InputField className="col-span-1 smrev:col-span-2" labelName="Last  Name" type="text" uni="lastName" placeholder="Last Name" />
              <InputField className="col-span-2" labelName="Email" type="text" uni="email" placeholder="Email" />
              <InputField className="col-span-2" labelName="Mobile No" type="number" uni="mobileNo" placeholder="Mobile No" />
              <InputField className="col-span-1 smrev:col-span-2" labelName="Password" type="password" uni="password" placeholder="Password" />
              <InputField className="col-span-1 smrev:col-span-2" labelName="Confirm Password" type="password" uni="repeatedPassword" placeholder="Password" />
            </div>
            <div>
