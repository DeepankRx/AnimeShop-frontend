...
const SellerDashboard = () => {
  ...
  const PAGES = [SELLER_LINKS.SellerDashboardDefault, SELLER_LINKS.AddProduct, SELLER_LINKS.SellerProducts, SELLER_LINKS.EditProduct];
      ...
      <div className="min-w-[300px]  h-[calc(100vh_-_142px)] mdrev:hidden bg-white rounded-2xl">
        <div className="flex flex-col items-center my-8">
          <div className="bg-green-100 w-28 h-28  rounded-full relative overflow-hidden shadow-lg">
            <img src={`${user.profilePicture}`} className="w-[100%] h-[100%] object-cover" alt='profile' />
          </div>
