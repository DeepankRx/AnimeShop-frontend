  ...
  const onSubmit = (values, { resetForm }) => {
    if (preview.length === 0) {
      ...
      if (editingMode) {
        ...
        values.subCategories.forEach((sub) =>
          formData.append("subCategories", sub)
        );
        values.hashtags.forEach((hashtag) =>
        ...
        <div className="mr-4 p-4 smrev:mr-0">
          ...
          >
            <Form className="flex flex-col gap-4">
                    ...
                    return (
                      <>
                        {variants.map((item, index) => (
                          <div
                            className="relative col-span-2  grid grid-cols-2 lgrev:grid-cols-1  gap-4"
                            key={index}
                          >
                            <InputField
                              override={true}
              ...
              <a
                href={ALL_LINKS.SizingGuide.pageLink}
                target="_blank"
